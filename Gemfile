...
group :test do
  ...
  gem 'gitlab_quality-test_tooling', '~> 3.2.1', require: false, feature_category: :tooling
end
...
gem "gitlab-cloud-connector", "~> 1.37", require: 'gitlab/cloud_connector', feature_category: :plan_provisioning
